...
{
    public class StartSprintReviewModalTest : TestContext
    {
        private readonly IRenderedComponent<StartSprintReviewModal> _component;

        private Sprint _sprint;

        public StartSprintReviewModalTest() 
        {
            _sprint = new() {
                Name = "Test sprint",
            };
            ...
            _component = RenderComponent<StartSprintReviewModal>();
        }
        ...
        {
            var resultTask = await Show();
            _component.Find("#confirm-review-sprint").Click();
