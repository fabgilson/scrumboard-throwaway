...
{
    public class SubmitSprintReviewModalTest : TestContext
    {
        private readonly IRenderedComponent<SubmitSprintReviewModal> _component;

        private Sprint _sprint;

        public SubmitSprintReviewModalTest() 
        {
            _sprint = new() {
                Name = "Test sprint",
            };
            ...
            _component = RenderComponent<SubmitSprintReviewModal>();
        }
        ...
        {
            var resultTask = await Show();
            _component.Find("#confirm-submit-sprint-review").Click();
