...
namespace ScrumBoard.Migrations
{
    ...
    [Migration("20231229020508_AddCreatedAndLastUpdatedColumnsToAnswers")]
    partial class AddCreatedAndLastUpdatedColumnsToAnswers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScrumBoard.Models.Entities.StandUpMeetingTaskCheckIn", b =>
                {
                    b.Property<long>("StandUpMeetingId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("StandUpMeetingId", "TaskId", "UserId");

                    b.HasIndex("TaskId");

                    b.HasIndex("UserId");

                    b.ToTable("StandUpMeetingTaskCheckIns");
                });
            ...
            modelBuilder.Entity("ScrumBoard.Models.Entities.Changelog.StandUpMeetingTaskCheckInChangelogEntry", b =>
                {
                    b.HasBaseType("ScrumBoard.Models.Entities.Changelog.ChangelogEntry");

                    b.Property<long>("CheckInStandUpMeetingId")
                        .HasColumnType("bigint");

                    b.Property<long>("CheckInTaskId")
                        .HasColumnType("bigint");

                    b.Property<long>("CheckInUserId")
                        .HasColumnType("bigint");

                    b.HasIndex("CheckInStandUpMeetingId", "CheckInTaskId", "CheckInUserId");

                    b.HasDiscriminator().HasValue("StandUpMeetingTaskCheckInChangelogEntry");
                });
            ...
            modelBuilder.Entity("ScrumBoard.Models.Entities.Changelog.StandUpMeetingTaskCheckInChangelogEntry", b =>
                {
                    b.HasOne("ScrumBoard.Models.Entities.StandUpMeetingTaskCheckIn", "CheckIn")
                        .WithMany()
                        .HasForeignKey("CheckInStandUpMeetingId", "CheckInTaskId", "CheckInUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
