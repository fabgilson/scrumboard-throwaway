...
dotnet test IdentityProvider.Tests \
  /p:CollectCoverage=true \
  /p:CoverletOutputFormat=opencover \
  /p:CoverletOutput=../CoverageReports/identity-provider.opencover.xml \
...
chown "$FINAL_UID":"$FINAL_GID" CoverageReports/identity-provider.opencover.xml
