...
dotnet test ScrumBoard.Tests \
  /p:CollectCoverage=true \
  /p:CoverletOutputFormat=opencover \
  /p:CoverletOutput=../CoverageReports/scrum-board.opencover.xml \
...
chown "$FINAL_UID":"$FINAL_GID" CoverageReports/scrum-board.opencover.xml
